%% predicitng labels of Subject 4
%%
clc;
clear;
close all;

%% Load the "parsed_P04T.mat"
T_filename = 'C:\Users\arashharatian\Documents\Work\Examples\Cognitive\WCCI2020\competition dataset WCCI2020\Clinical-Brain-Computer-Interfaces-Challenge-WCCI-2020-Glasgow-master\T\parsed_P04T.mat'; %put your "parsed_P04T.mat" file here
load(T_filename);

%% Filtering "RawEEGData" using 'butter' and 'filtfilt' with 8 or 30 cutoff frequency
data = mybutterfilter(RawEEGData, 8, 30);
...
%% Loading the "parsed_P04E.mat"
E_filename = 'C:\Users\arashharatian\Documents\Work\Examples\Cognitive\WCCI2020\competition dataset WCCI2020\Clinical-Brain-Computer-Interfaces-Challenge-WCCI-2020-Glasgow-master\E\parsed_P04E.mat'; %put your "parsed_P04E.mat" file here
load(E_filename);
...
%% Extracting Features with the same 'w' that previously used in "parsed_P04T.mat"
