%% predicitng labels of Subject 6
%%
clc;
clear;
close all;

%% Load the "parsed_P06T.mat"
...
%% Extracting Features with the same 'w' that previously used in "parsed_P06T.mat"
