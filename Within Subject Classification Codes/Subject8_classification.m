%% predicitng labels of Subject 8
%%
clc;
clear;
close all;

%% Load the "parsed_P08T.mat"
T_filename = 'C:\Users\arashharatian\Documents\Work\Examples\Cognitive\WCCI2020\competition dataset WCCI2020\Clinical-Brain-Computer-Interfaces-Challenge-WCCI-2020-Glasgow-master\T\parsed_P08T.mat'; %put your "parsed_P08T.mat" file here
load(T_filename);
...
%% Loading the "parsed_P08E.mat"
E_filename = 'C:\Users\arashharatian\Documents\Work\Examples\Cognitive\WCCI2020\competition dataset WCCI2020\Clinical-Brain-Computer-Interfaces-Challenge-WCCI-2020-Glasgow-master\E\parsed_P08E.mat'; %put your "parsed_P08E.mat" file here
load(E_filename);

%% Filtering "RawEEGData" using 'butter' and 'filtfilt' with 2.1 or 30 cutoff frequency
evaluation_data = mybutterfilter(RawEEGData, 12, 30);

%%
evaluation_data = my3Dmatrix(evaluation_data);

%% Extracting Features with the same 'w' that previously used in "parsed_P08T.mat"
